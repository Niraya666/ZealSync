...
ls ~/.hermes/memories/USER.md 2>/dev/null && echo "HAS_HERMES"
```
...
| Harness | 提取来源 | 提取内容 |
|---|---|---|
| **claude-code** | `~/.claude/projects/**/memory/*.md`（`type: project`） | 技能、项目经验、兴趣、工作风格 |
| **openClaw** | `~/.openclaw/workspace/USER.md` | 已有的画像数据 |
| **Hermes** | `~/.hermes/memories/USER.md` | 已有的画像数据 |
